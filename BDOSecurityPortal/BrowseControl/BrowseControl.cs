...
namespace BDOSecurityPortal
{
    ...
    public class BrowseControl : TabControl
    {
        private int btnCloseWidth = 10;
        private int btnCloseHeight = 10;

        public BrowseControl() : base()
        {
        ...
        private void PaintTabImage(System.Drawing.Graphics graph, int index)
        {
            ...
            if (tabImage != null)
            {
                ...
                graph.DrawImage(tabImage, rect.Right - rect.Height, 6, btnCloseWidth, btnCloseHeight);       //Edit By Marvin
            }
        }
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            r.Offset(r.Width - btnCloseWidth - 3, 2);
            r.Width = btnCloseWidth;
            r.Height = btnCloseHeight;
