...
namespace BDOSecurityPortalUtil
{
    sealed class ADHelper
    {
        ...
        private static string DomainName = "ad.bdo.com.cn";    //测试用
        /// <summary>
        /// LDAP 地址
        /// </summary>
        //private static string LDAPDomain = "DC=net,DC=TD-TECH";
        private static string LDAPDomain = "DC=bdo,DC=com,DC=cn";

        /// <summary>
        /// LDAP绑定路径
        /// </summary>
        //private static string ADPath = "LDAP://Contoso.com";     //测试用
        private static string ADPath = "LDAP://ad.bdo.com.cn";     //测试用

        //private static string sPrincpleNameTail = "@cinf.com";
        private static string sPrincpleNameTail = "@bdo.com.cn";
        /// <summary>
        /// 登录帐号
        /// </summary>
        //private static string ADUser = @"contoso\oa";
        private static string ADUser = @"idau";
        /// <summary>
        /// 登录密码
        /// </summary>
        //private static string ADPassword = "3edc5tgB"; //实际
        //private static string ADPassword = "1qaz2wsX";   //测试用
        private static string ADPassword = "idSecure.2012";   //测试用
